...
// import Logo from '../public/Images/logofindaplace.png';
    ...
    <div className="nav-container" data-testid="navbar">
      <Navbar color="light" light expand="md">
        <Container>
          ...
          <NavbarBrand>
            <img src="https://img.icons8.com/ios-filled/2x/polygonal-tent.png" style={{height:"50px"}} alt="logo" />
          </NavbarBrand>
          <NavbarToggler onClick={toggle} data-testid="navbar-toggle" />
          <Collapse isOpen={isOpen} navbar>
            <Nav className="mx-auto" navbar data-testid="navbar-items">
              <NavItem>
